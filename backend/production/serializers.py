...
class GoldBatchSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = (
            ...
            "fine_weight_g", "fineness", "status", "status_display", "security_status", "listed_for_sale", "asking_price_ghs", "seal_number", "origin_latitude", "origin_longitude", "field_notes", "source_lots", "is_aggregated", "mass_balance_ok",
        ...
        read_only_fields = (
            ...
            "status", "security_status", "listed_for_sale", "asking_price_ghs", "seal_number", "origin_latitude", "origin_longitude", "field_notes", "source_lots", "is_aggregated", "mass_balance_ok", "created_by", "current_owner", "created_at", "updated_at",
        )
