...
class RegisterSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        if pos is not None:
            validated_data["role"] = pos.base_role
...
class AdminUserSerializer(serializers.ModelSerializer):
    role_display = serializers.CharField(source="display_title", read_only=True)
    position_title = serializers.CharField(source="position.title", read_only=True, default=None)

    class Meta:
        model = User
        fields = ("id", "username", "email", "first_name", "last_name", "role", "position", "position_title",
...
class AdminUserCreateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ("id", "username", "email", "password", "first_name", "last_name",
                  "role", "position", "phone", "organization", "region", "district",
                  "latitude", "longitude")
...
class PositionSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        model = Position
        fields = ("id", "title", "base_role", "base_role_display", "description", "active",
                  "user_count", "created_at")
        read_only_fields = ("id", "created_at")

    def get_user_count(self, o):
